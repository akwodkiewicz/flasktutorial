...
def add_departments():
    ...
    if form.validate_on_submit():
        ...
        try:
            # add department to the dataabase
...
def list_employees():
    ...
    check_admin()
    employees = Employee.query.filter_by(is_admin=False)
    admins = Employee.query.filter_by(is_admin=True)

    return render_template('admin/employees/employees.html', 
        employees=employees, admins=admins, title='Pracownicy')
...
def assign_employee(id):
    ...
    if form.validate_on_submit():
        ...
        db.session.commit()
        flash('Przypisanie roli i działu zakończone sukcesem')
